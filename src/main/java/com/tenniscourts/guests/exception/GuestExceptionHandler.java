...
import com.tenniscourts.guests.model.ServiceError;
...
public class GuestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleGenericException(GuestNotFoundException ex) {
		String error = "Guest not found!";
